...
const NeoFetch_info = () => {
  ...
  return (
    <div className='nf-info'>
        ...
        <div className="nf-row"><span className="k">GitHub</span><span className="v"><a href="${USER.github.url}" target="_blank" rel="noopener">${USER.github.label}</a></span></div>
        <div className="nf-row"><span className="k">LinkedIn</span><span className="v"><a href="${USER.linkedin.url}" target="_blank" rel="noopener">${USER.linkedin.label}</a></span></div>
        <div className="nf-row"><span className="k">Email</span><span className="v"><a href="${USER.email.url}">${USER.email.label}</a></span></div>
        <div className="nf-row"><span className="k">Website</span><span className="v"><a href="${USER.website.url}" target="_blank" rel="noopener">${USER.website.label}</a></span></div>
